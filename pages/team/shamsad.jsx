...
export default function TeamDetails() {
  ...
  return (
    <>
          ...
          <Div className="row align-items-center">
            ...
            <Div className="col-lg-6 offset-xl-1">
              ...
              <Div className="cs-section_heading cs-style1">
                <h2 className="cs-section_title">Shamsad</h2>
      ...
      <Link href="https://www.facebook.com/shamsadp.kottaram" className="cs-center">
        <Icon icon="fa6-brands:facebook" />
      </Link>
      <Link href="https://www.instagram.com/shamzgea/" className="cs-center">
        <Icon icon="fa6-brands:instagram" />
      </Link>
      <Link href="https://www.linkedin.com/in/shamsad-p-062b69237/" className="cs-center">
