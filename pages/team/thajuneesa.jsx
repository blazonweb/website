...
export default function TeamDetails() {
  ...
  return (
    <>
      <Head>
        <title>Team - Thajuneesa</title>
        <meta name="description" content="Thajuneesa - Web Developer at Blazon Web" />
          ...
          <Div className="row align-items-center">
            ...
            <Div className="col-lg-6 offset-xl-1">
              ...
              <Div className="cs-section_heading cs-style1">
                <h2 className="cs-section_title">Thajuneesa</h2>
